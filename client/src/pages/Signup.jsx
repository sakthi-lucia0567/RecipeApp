...
const Signup = () => {
  ...
  return (
    <div className='w-full max-w-sm mt-16 mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800'>
      <div className='px-6 py-4'>
        <h3 className='mt-3 text-xl font-medium text-center text-gray-600 dark:text-gray-200'>
          Welcome Back
        </h3>

        <p className=' text-center  text-gray-500 mt-1 dark:text-gray-400'>
          Register
        </p>
